...
namespace Microsoft.CodeAnalysis.Editor.Implementation.IntelliSense.Completion
{
    ...
    {
        VisualStudio.Commanding.CommandState IChainedCommandHandler<AutomaticLineEnderCommandArgs>.GetCommandState(AutomaticLineEnderCommandArgs args, Func<VisualStudio.Commanding.CommandState> nextHandler)
        {
            AssertIsForeground();
            return nextHandler();
        }
