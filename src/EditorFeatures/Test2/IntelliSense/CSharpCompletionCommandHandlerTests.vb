    ...
    {$$
        ...
        int doodle;
                ...
                Using disposableView As DisposableTextView = textViewFactory.CreateDisposableTextView(projection)
                    ...
                    state.CompletionCommandHandler.ExecuteCommand(New DeleteKeyCommandArgs(disposableView.TextView, state.SubjectBuffer), Sub() editorOperations.Delete(), New TestCommandExecutionContext())
