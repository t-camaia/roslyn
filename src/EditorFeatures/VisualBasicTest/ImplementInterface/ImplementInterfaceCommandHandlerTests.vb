    ...
    Public Class ImplementInterfaceCommandHandlerTests
        ...
        Private Sub Test(code As XElement, expectedText As XElement, nextHandler As Action(Of IWpfTextView, TestWorkspace), assertion As Action(Of String, String, IWpfTextView))
            Using workspace = GetWorkspace(code.NormalizedValue)
                ...
                commandHandler.ExecuteCommand(New ReturnKeyCommandArgs(view, view.TextBuffer), Sub() nextHandler(view, workspace), New TestCommandExecutionContext())
        ...
        Private Shared Function MoveCaretAndCreateCommandHandler(workspace As TestWorkspace) As IChainedCommandHandler(Of ReturnKeyCommandArgs)
...
End Interface")
                ...
                Dim view = workspace.Documents.Single().GetTextView()
                commandHandler.ExecuteCommand(New ReturnKeyCommandArgs(view, view.TextBuffer), Sub() nextHandlerCalled = True, New TestCommandExecutionContext())
